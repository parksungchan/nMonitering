...
RG1 = ['래쉬가드', '래쉬가드추천', '래쉬가드브랜드', '래쉬가드세트', '집업래쉬가드', '수영복래쉬가드', '여성래쉬가드', '여자래쉬가드', '여성래쉬가드세트', '여성집업래쉬가드']
RG = crolling_util.add_key(RG, RG1)

VK = ['왕뽕비키니', '모노키니', '하이웨스트비키니', '비키니', '수영복', ' 여성수영복', '여자수영복']
VK1 = ['원피스수영복', '원피스비키니', '실내수영복', '비키니쇼핑몰', '섹시비키니', '비키니브랜드', '수영복쇼핑몰', '실내수영장수영복']
...
strArr = 'R54'
crolling_util.get_rank_product(strArr, RG, sIdx, eIdx, pagePrintCnt)
